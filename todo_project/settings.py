...
SECRET_KEY = os.environ.get('SECRET_KEY', default='django-insecure-sp@pwnz_oxf44x!@1dc$7u2!is28+z9b^(qs@=v83ky@^+be6$')
...
if REDIS_URL:
    ...
    # Dev-friendly default that requires no external services.
    CHANNEL_LAYERS = {
        'default': {
...
AUTH_PASSWORD_VALIDATORS = [
    # Removing all advanced password validators so any password can be used
]
